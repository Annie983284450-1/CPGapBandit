...
class get_params():
    ...
    def get_train_test_set(self):
        ...
        final_result_path = '../cpbandit_results/' +   f'test{num_test_pat}_train_{num_train_sepsis_pat*2}'  +f'_max_u_tp={self.max_u_tp}_min_u_fn={self.min_u_fn}_u_fp={self.u_fp}_u_tn={self.u_tn}/'
